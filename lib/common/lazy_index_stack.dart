...
class LazyIndexedStack extends StatefulWidget {
  ...
  /// Alignment of the children of the [IndexedStack].
  final AlignmentGeometry alignment;

  /// TextDirection of the children of the [IndexedStack].
  final TextDirection textDirection;

  /// StackFit of the children of the [IndexedStack].
